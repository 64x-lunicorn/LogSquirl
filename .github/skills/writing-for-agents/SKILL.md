...
**Plain text** is one such guardrail, and it binds twice: the document you write, and the output it specifies. Carry emphasis with words, bold, tables, code fences, and text diagrams — no emoji in an output template, a report format, a script's console lines, or a message the agent addresses to the user.
