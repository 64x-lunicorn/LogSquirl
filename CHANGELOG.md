...
## New features:
 ...
 - Added Filters Panel: floating window for toggling multiple predefined filters with search, select/deselect all, and pinned filters that persist across sessions
