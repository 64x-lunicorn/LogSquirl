...
# Overhead  Command          Shared Object                  Symbol  
     4.84%  Thread (pooled)  logsquirl_portable                 [.] std::vector<`QString`, std::allocator<`QString`> >::~vector
     ...
     2.05%  Thread (pooled)  logsquirl_portable                 [.] CompressedLinePositionStorage::at
     1.91%  Thread (pooled)  logsquirl_portable                 [.] IndexOperation::parseDataBlock
     ...
     1.26%  Thread (pooled)  logsquirl_portable                 [.] LogData::decodeLines
...
So during search operation _LogSquirl_ creates and destroys `QString` and `QByteArray` 
...
_LogSquirl_ has been using the scalable memory allocator provided by the Intel
...
running and competing for memory allocation. On the other hand logsquirl uses
...
logsquirl executable is linked with the mimalloc-override.o file. This file must be provided first so
...
logsquirl use cases. Both indexing and search are around 10% faster.
...
# Overhead  Command          Shared Object                  Symbol
     ...
     4.53%  logsquirl_portable_  libc-2.32.so                   [.] 0x000000000015e01f
     4.43%  Thread (pooled)  libicuuc.so.68.2               [.] 0x00000000000e86d0
     3.47%  Thread (pooled)  logsquirl_portable                 [.] CompressedLinePositionStorage::at
...
memory allocator on MacOS. LogSquirl crashes with segmentation fault right at the start. So
