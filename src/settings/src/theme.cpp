...
Theme Theme::highContrast()
{
    ...
    theme.setColors( {
        ...
        // Outlined only, not filled: yellow on black reaches AAA.
        { DefaultButton, "#000000" },
        { DefaultButtonText, "#FFFF00" },
        { DefaultButtonBorder, "#FFFF00" },
        { DefaultButtonHover, "#1F1F1F" },
        { DefaultButtonFocusBorder, "#FFFFFF" },
    } );

    using enum StyleToken;
    theme.setValues( {
        // Sizes and shapes are Dark's (#264); only borders and outlines are
        // thicker, and a padding inside a border shrinks by as much.
        { BorderWidth, "2px" },
        { OutlineWidth, "1px" },
