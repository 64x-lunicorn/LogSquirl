...
void TabbedScratchPad::applyTheme()
{
    // The same tab height and close buttons as the main tab bar.
    tabWidget_->setStyleSheet( closableTabBarStyleSheet( Theme::active() ) );
}
