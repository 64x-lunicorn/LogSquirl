...
QString closableTabBarStyleSheet( const Theme& theme )
{
    ...
    // (#264), shown only on the selected tab and under the mouse (#265). The images are the
    // application's own on every platform, which also avoids the missing tab close icons of Qt's
    // macOS style (QTBUG-61092).
